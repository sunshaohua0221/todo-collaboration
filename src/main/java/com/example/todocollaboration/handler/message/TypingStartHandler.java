 ...
 */
@Component
public class TypingStartHandler extends BaseMessageHandler {
    ...
    public void handleMessage(Long userId, Map<String, Object> message) throws Exception {
        ...
        // 广播输入状态到列表
        broadcastToList(listId, userId, MessageTypeConstant.TYPE_USER_TYPING_START, Map.of(
                "userId", userId,
                "listId", listId,
                "timestamp", new Date()
        ));
    ...
    public void afterPropertiesSet() throws Exception {
        HandlerFactory.register(MessageTypeConstant.TYPE_USER_TYPING_START, this);
    }
